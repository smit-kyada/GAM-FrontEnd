...
import { UPDATE_AFFREQUEST } from 'src/graphql/mutation/affRequest'
...
const UpdateAffRequest = props => {

    // ** Props
    const { open, toggle, affRequestRes, userData } = props
    ...
    // ** Graphql
    const [addUser] = useMutation(UPDATE_AFFREQUEST);
    ...
    return (
        ...
        >
            <Header>
                <Typography variant='h6'>Update Affiliate Request</Typography>
                <IconButton
                    size='small'
                    onClick={handleClose}
...
export default UpdateAffRequest
