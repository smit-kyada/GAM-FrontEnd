...
import { CREATE_SITETABLE } from 'src/graphql/mutation/siteTable'
...
import { CREATE_COUNTRYTABLE } from 'src/graphql/mutation/countryTable'
...
const AddCountryTable = props => {

  // ** Props
  const { open, toggle, siteTableRefetch } = props
  ...
  // ** Graphql
  const [createSiteTable] = useMutation(CREATE_COUNTRYTABLE);
  ...
  return (
    ...
    >
      <Header>
        <Typography variant='h6'>Create Country Table</Typography>
        <IconButton
          size='small'
          onClick={handleClose}
...
export default AddCountryTable
