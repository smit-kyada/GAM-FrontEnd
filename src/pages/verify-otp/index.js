...
import { RESEND_OTP, VARIFY_REGISTER_OTP } from 'src/graphql/mutation/user'
...
const VerifyOtp = () => {
  ...
  // OTP verification
  const [varifyOtp] = useMutation(VARIFY_REGISTER_OTP)
  ...
  const onSubmit = (data) => {
    ...
    varifyOtp({
      ...
      toast.success(result?.data?.verifyRegisterOtp)
      router.push("/login")
              ...
              <Card>
                <CardContent sx={{ p: theme => `${theme.spacing(10.5, 8, 8)} !important` }}>
                  ...
                  <Box sx={{ mb: 6 }}>
                    ...
                    {/* <Typography sx={{ fontWeight: 500 }}>******{messageData?.getJWTUserId?.contact?.toString().slice(-4)}</Typography> */}
